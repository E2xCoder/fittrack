        ...
        <>
          ...
          <div className="relative mb-6">
            ...
            {suggestions.length > 0 && (
              <div className="absolute z-10 mt-1 w-full rounded-xl border border-zinc-700 bg-zinc-900 shadow-xl overflow-hidden">
                  ...
                  <div className="space-y-2">
                    {exercise.sets.map((set, setIdx) => (
                      <div key={setIdx} className="grid grid-cols-4 gap-2 items-center">
                        <span className="text-sm font-medium text-zinc-400 pl-1">
                          {set.setNumber}
                        </span>
                        <input
                          type="number"
